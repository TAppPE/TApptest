        ...
        <div id="section">
            ...
            <div id="chosenSportContainer">
                ...
                <div class="sportStats">                  
                   <div id="sportimage">
                   <div class="hover">
                    <Link to ='/Footballskill' > <button id="footballBtn"><div class="hover"></div></button> </ Link>
                </div>
                       </div>                  
                   <div id="trafficLight">
                ...
                <div class="sportStats">
                   <div id="sportimageb">
                       ...
                       <div class="hover">
                       <Link to ='/Tennis' > <button id="footballBtn"><div class="hover"></div></button> </ Link>
                       </div>
                       </button>
                       </div>
                   <div id="trafficLight">
                ...
                <div class="sportStats">
                   ...
                   <button class="invisible-btn">
                   <div class="hover">
                    <Link to ='/Basketball' > <button id="footballBtn"><div class="hover"></div></button> </ Link>
